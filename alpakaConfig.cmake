...
IF(ALPAKA_ACC_CPU_B_OMP2_T_SEQ_ENABLE OR ALPAKA_ACC_CPU_B_SEQ_T_OMP2_ENABLE OR ALPAKA_ACC_CPU_BT_OMP4_ENABLE)
    ...
    ELSE()
        ...
        IF(OpenMP_CXX_VERSION VERSION_LESS 4.0)
            MESSAGE(STATUS "OpenMP 4.0 is not supported! OpenMP 4.0 back-end disabled!")
            SET(ALPAKA_ACC_CPU_BT_OMP4_ENABLE OFF CACHE BOOL "Enable the OpenMP 4.0 CPU block and thread back-end" FORCE)
        ENDIF()
...
ENDIF()
        ...
        MESSAGE("_ALPAKA_COMPILE_OPTIONS_PUBLIC: ${_ALPAKA_COMPILE_OPTIONS_PUBLIC}")
        MESSAGE("_ALPAKA_LINK_FLAGS_PUBLIC: ${_ALPAKA_LINK_FLAGS_PUBLIC}")
...
SET_SOURCE_FILES_PROPERTIES(${_ALPAKA_FILES_OTHER} PROPERTIES HEADER_FILE_ONLY TRUE)
        ...
        MESSAGE("_ALPAKA_COMPILE_OPTIONS_PUBLIC: ${_ALPAKA_COMPILE_OPTIONS_PUBLIC}")
        MESSAGE("_ALPAKA_COMPILE_DEFINITIONS_PUBLIC: ${_ALPAKA_COMPILE_DEFINITIONS_PUBLIC}")
        MESSAGE("_ALPAKA_INCLUDE_DIRECTORIES_PUBLIC: ${_ALPAKA_INCLUDE_DIRECTORIES_PUBLIC}")
        MESSAGE("_ALPAKA_LINK_LIBRARIES_PUBLIC: ${_ALPAKA_LINK_LIBRARIES_PUBLIC}")
        MESSAGE("_ALPAKA_LINK_FLAGS_PUBLIC: ${_ALPAKA_LINK_FLAGS_PUBLIC}")
#-------------------------------------------------------------------------------
# Target.
...
LIST(APPEND alpaka_LIBRARIES ${_ALPAKA_LINK_LIBRARIES_PUBLIC})
        ...
        MESSAGE("alpaka_COMPILE_OPTIONS: ${alpaka_COMPILE_OPTIONS}")
        MESSAGE("alpaka_COMPILE_DEFINITIONS: ${alpaka_COMPILE_DEFINITIONS}")
        MESSAGE("alpaka_DEFINITIONS: ${alpaka_DEFINITIONS}")
        MESSAGE("alpaka_INCLUDE_DIRS: ${alpaka_INCLUDE_DIRS}")
        MESSAGE("alpaka_LIBRARIES: ${alpaka_LIBRARIES}")
#-------------------------------------------------------------------------------
