...
if [[ -v ALPAKA_ACC_CPU_B_SEQ_T_COROUTINES_ENABLE ]]
then
    ALPAKA_DOCKER_ENV_LIST+=("--env" "ALPAKA_ACC_CPU_B_SEQ_T_COROUTINES_ENABLE=${ALPAKA_ACC_CPU_B_SEQ_T_COROUTINES_ENABLE}")
fi
